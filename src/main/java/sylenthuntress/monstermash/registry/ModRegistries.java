...
public class ModRegistries {
    ...
    public static Registry<NumberSupplierType> NUMBER_SUPPLIER_TYPES = registerSimple(ModRegistryKeys.NUMBER_SUPPLIER_TYPES);
    public static Registry<StringSupplierType> STRING_SUPPLIER_TYPES = registerSimple(ModRegistryKeys.STRING_SUPPLIER_TYPES);
